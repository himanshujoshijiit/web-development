    ...
    <?php
      ...
      <form method="post" action="">
        ...
        if(isset($_POST['submit']))
        {
          ...
          $res=mysqli_query($set,"SELECT * FROM `issue_book` where username='$_POST[username]' and bid='$_POST[bid]' ;");
      ...
      while($row=mysqli_fetch_assoc($res))
      {
        ...
        if($diff>=0)
        {
          ...
          $x= date("Y-m-d"); 
          mysqli_query($set,"INSERT INTO `fine` VALUES ('$_POST[username]', '$_POST[bid]', '$x', '$day', '$fine','not paid') ;");


          $var1='<p style="color:yellow; background-color:green;">RETURNED</p>';
          mysqli_query($set,"UPDATE issue_book SET approve='$var1' where username='$_POST[username]' and bid='$_POST[bid]' ");

          mysqli_query($set,"UPDATE books SET quantity = quantity+1 where bid='$_POST[bid]' ");
